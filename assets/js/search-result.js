...
if (searchResult === "food") {
  ...
  var food = {
    choices: [
      [
        "Black risotto",
        "assets/images/search-result-images/food-img-1.png",
      ...
      [
        "Boškarin",
        "assets/images/search-result-images/food-img-2.png",
      ...
      [
        "Brodetto",
        "assets/images/search-result-images/food-img-3.png",
      ...
      [
        "Buzara",
        "assets/images/search-result-images/food-img-4.png",
      ...
      [
        "Fritule",
        "assets/images/search-result-images/food-img-5.png",
      ...
      [
        "Peka",
        "assets/images/search-result-images/food-img-6.png",
  ...
  var statutes = {
    choices: [
      [
        "Pula Arena",
        "assets/images/search-result-images/pula-arena.png",
        "This famous monument in Croatia also being among the six largest surviving Roman arenas in the World. Bloodshed with spectacular gladiator fighting being one of the most famous purposes of the amphitheater.",
      ],
      [
        "Ban Jelačić Square",
        "assets/images/search-result-images/ban-square.png",
        "Named after ban Josip Jelačić and being the central square of Zagreb. This best monument in Croatia is located below Zagreb’s old city cores Gradec and Kaptol. The square features a large statue of Josip Jelačić. With his sword out riding a horse that adds a certain charm to the square in general.",
      ],
      [
        "Trakoscan Castle",
        "assets/images/search-result-images/castle.png",
        "This historic beauty of this Trakoscan Castle looks like something from a fairy tale. Being built in the 13th century, the castle is located in the northern region of Croatia. Between from Ptuj to Bednja, it was meant as an observation fortress to monitor the valley.",
      ],
      [
        "Dubrovnik’s City Walls",
        "assets/images/search-result-images/walls.png",
        "After the city gained its full independence from Venetian suzerainty, the present shape of the walls was defined in the 14th century but the peak of its construction lasted from the beginning of the 15th century until the latter half of the 16th century.",
      ],
    ],
  };
